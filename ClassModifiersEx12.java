...
class ForAbstractUse extends AbstractClass {
    short day = 5;
    void absmethod(){
...
public class ClassModifiersEx12 {
    final int x = 15;
    ...
    public static void main(String[] args){
        ...
        ClassModifiersEx12 modifierObj = new ClassModifiersEx12();
        ...
        ClassModifiersEncapEx12 encapObj = new ClassModifiersEncapEx12();
